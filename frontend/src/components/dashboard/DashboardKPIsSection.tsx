      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bank-card p-5 bg-white border border-[#E2E8F0] shadow-sm space-y-2">
          <div className="flex items-center justify-between">
            ...
            <div className="h-8 w-8 rounded-lg bg-[#F5F7FA] border border-[#E2E8F0] flex items-center justify-center text-[#132443]">
              <Users className="h-4 w-4" />
            </div>
          </div>
          <div className="flex items-baseline justify-between">
            <span className="text-3xl font-extrabold text-[#132443] font-mono">{kpis.total_leads}</span>
        ...
        <div className="bank-card p-5 bg-white border border-[#E2E8F0] shadow-sm space-y-2">
          ...
          <div className="flex items-baseline justify-between">
            <span className="text-3xl font-extrabold text-[#132443] font-mono">{kpis.qualification_rate}%</span>
        ...
        <div className="bank-card p-5 bg-white border border-[#E2E8F0] shadow-sm space-y-2">
          ...
          <div className="flex items-baseline justify-between">
            <span className="text-2xl sm:text-3xl font-extrabold text-[#132443] font-mono">
      ...
      <div className="bank-card p-5 bg-white border border-[#E2E8F0] shadow-sm space-y-3">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          ...
          <div className="rounded-xl bg-[#F5F7FA] p-3.5 border border-[#E2E8F0] text-left">
            ...
            <span className="text-xl font-bold text-[#132443] font-mono">{kpis.conversion_pipeline.new}</span>
            <div className="mt-2 h-1.5 w-full bg-[#E2E8F0] rounded-full overflow-hidden">
              <div className="h-full bg-[#132443] w-full" />
            </div>
          </div>
          ...
          <div className="rounded-xl bg-[#F5F7FA] p-3.5 border border-[#E2E8F0] text-left">
            ...
            <span className="text-xl font-bold text-[#132443] font-mono">{kpis.conversion_pipeline.qualified}</span>
            <div className="mt-2 h-1.5 w-full bg-[#E2E8F0] rounded-full overflow-hidden">
              <div className="h-full bg-[#132443] w-[67%]" />
            </div>
          </div>
          ...
          <div className="rounded-xl bg-[#F5F7FA] p-3.5 border border-[#E2E8F0] text-left">
            ...
            <span className="text-xl font-bold text-[#132443] font-mono">{kpis.conversion_pipeline.contacted}</span>
            <div className="mt-2 h-1.5 w-full bg-[#E2E8F0] rounded-full overflow-hidden">
              <div className="h-full bg-[#132443] w-[36%]" />
            </div>
          </div>
