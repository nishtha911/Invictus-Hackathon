      ...
      <div className="mt-6 grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-7 space-y-6">
          <div>
            ...
            <h2 className="text-2xl sm:text-3xl font-extrabold text-[#132443] tracking-tight mt-1">
              {loan.name}
            </h2>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
            ...
            <div className="rounded-xl border border-[#E2E8F0] bg-[#F5F7FA] p-4">
              ...
              <span className="text-2xl font-extrabold text-[#132443] font-mono mt-0.5 block">
        ...
        <div className="lg:col-span-5 space-y-5 flex flex-col justify-between h-full">
          ...
          <div className="rounded-xl border border-[#E2E8F0] bg-[#F5F7FA] p-5 space-y-3">
            ...
            <div className="pt-3 border-t border-[#E2E8F0]">
              <button
                ...
                className="w-full flex items-center justify-between text-[11px] font-semibold text-slate-600 hover:text-[#132443] transition-colors cursor-pointer"
              >
                    ...
                    {loan.policy_citations && loan.policy_citations.length > 0 && (
                      <div className="space-y-1.5 pt-1">
                        {loan.policy_citations.map((cite, i) => (
                          ...
                          >
                            <span className="font-semibold text-[#132443] font-mono">{cite.clause_id}</span> ·{" "}
          ...
          <div className="space-y-2.5 pt-2">
            ...
            <button
              ...
              className="w-full inline-flex items-center justify-center gap-1.5 rounded-xl border border-[#E2E8F0] bg-white py-2.5 text-xs font-semibold text-[#132443] hover:bg-[#F5F7FA] transition-colors cursor-pointer"
            >
