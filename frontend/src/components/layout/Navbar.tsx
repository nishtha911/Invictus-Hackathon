...
export function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-40 w-full bg-[#132443] text-white border-b border-white/10 shadow-sm">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">

        {/* Brand Logo */}
        <Link href="/" className="flex items-center gap-2.5 shrink-0 group">
          <div className="h-9 w-9 bg-white p-1 flex items-center justify-center shadow-sm group-hover:opacity-90 transition-opacity">
              ...
              <AnimatePresence>
                {loansDropdownOpen && (
                  <motion.div
                    ...
                    className="absolute left-1/2 -translate-x-1/2 top-full mt-2 w-[420px] rounded-xl bg-white p-3 shadow-lg border border-slate-200 grid grid-cols-2 gap-1 z-50"
                  >
                    {LOAN_PURPOSES.map((loan) => {
                      ...
                      return (
                        <Link
                          ...
                          className="flex items-center gap-2.5 p-2.5 hover:bg-slate-50 transition-colors group/item"
                        >
                          <div className="flex h-8 w-8 shrink-0 items-center justify-center bg-emerald-50 text-emerald-700 group-hover/item:bg-emerald-600 group-hover/item:text-white transition-colors">
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <button
            ...
            className="lg:hidden p-2 text-slate-300 hover:text-white hover:bg-white/10 transition-colors cursor-pointer"
          >
