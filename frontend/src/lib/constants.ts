...
export const BRAND = {
  ...
  subtext: "Explore suitable loan options for your home, car, or business with clear guidance, transparent recommendations, and a simpler borrowing experience.",
};
